...
```
**This package is no longer actively maintained and will be archived in February 2026**
</br>

GSS analysis function now recommend using [afcharts](https://best-practice-and-impact.github.io/afcharts/) for producing branded accessible charts. 
...
[![Codecov test coverage](https://codecov.io/gh/dhsc-govuk/fingertipscharts/graph/badge.svg)](https://app.codecov.io/gh/dhsc-govuk/fingertipscharts)
<!-- badges: end -->
